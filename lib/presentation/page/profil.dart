...
import 'package:rumakita_app2/presentation/page/Pengajuan_surat.dart';
import 'package:rumakita_app2/presentation/page/status_kegiatan.dart';
...
import 'package:rumakita_app2/presentation/page/splashtwo.dart';
import 'package:rumakita_app2/presentation/page/editprofil.dart';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => StatusKegiatanPage(),
                                )
                              );
                            },
                            child:CardProfil(
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => PengajuanSurat(),
                              )
                              );
                            },
                            child: CardProfil(
